...
/**
 * opération x86-64 binaire attention au sens : c'est {@code r2 <- r2 m r1}
 */
...
/**
 * instruction x86-64 de branchement (binaire) attention au sens : c'est le
 * résultat de {@code r2 cmp r1}
 */
